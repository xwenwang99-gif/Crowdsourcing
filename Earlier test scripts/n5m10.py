# -*- coding: utf-8 -*-
"""
Created on Tue Sep  3 15:50:11 2024
...
for seed in range(1):
    ...
    beta16 = np.array([0,k,0,0,0])
    beta17 = np.array([0,0,k,0,0])
    beta18 = np.array([0,0,0,0,k])
    beta19 = np.array([0,k,0,0,0])
    beta10 = np.array([0,0,0,0,k])
    ...
    beta27 = np.array([0,0,k,0,0])
    beta28 = np.array([0,0,0,k,0])
    beta29 = np.array([0,0,0,0,k])
    beta20 = np.array([0,0,0,k,0])
    ...
    beta36 = np.array([k,0,0,0,0])
    beta37 = np.array([0,0,0,0,0])
    beta38 = np.array([0,0,0,k,0])
    beta39 = np.array([0,0,0,0,0])
    beta30 = np.array([0,0,0,0,k])
    ...
    beta46 = np.array([0,k,0,0,0])
    beta47 = np.array([0,0,k,0,0])
    beta48 = np.array([k,0,0,0,0])
    beta49 = np.array([0,k,0,0,0])
    ...
    beta56 = np.array([0,k,0,0,0])
    beta57 = np.array([0,0,k,0,0])
    beta58 = np.array([0,0,0,k,0])
    beta59 = np.array([0,0,k,0,0])
    ...
    B1[5*n_worker//10: 6*n_worker//10, :] = np.random.multivariate_normal(beta16, 0.5 *np.eye(5), n_worker//10)
    B1[6*n_worker//10: 7*n_worker//10, :] = np.random.multivariate_normal(beta17, 0.5 *np.eye(5), n_worker//10)
    B1[7*n_worker//10: 8*n_worker//10, :] = np.random.multivariate_normal(beta18, 0.5 *np.eye(5), n_worker//10)
    B1[8*n_worker//10: 9*n_worker//10, :] = np.random.multivariate_normal(beta19, 0.5 *np.eye(5), n_worker//10)
    B1[9*n_worker//10:, :] = np.random.multivariate_normal(beta10, 0.5 *np.eye(5), n_worker//10)
    ...
    B2[5*n_worker//10: 6*n_worker//10, :] = np.random.multivariate_normal(beta26, 0.5 *np.eye(5), n_worker//10)
    B2[6*n_worker//10: 7*n_worker//10, :] = np.random.multivariate_normal(beta27, 0.5 *np.eye(5), n_worker//10)
    B2[7*n_worker//10: 8*n_worker//10, :] = np.random.multivariate_normal(beta28, 0.5 *np.eye(5), n_worker//10)
    B2[8*n_worker//10: 9*n_worker//10, :] = np.random.multivariate_normal(beta29, 0.5 *np.eye(5), n_worker//10)
    B2[9*n_worker//10:, :] = np.random.multivariate_normal(beta20, 0.5 *np.eye(5), n_worker//10)
    ...
    B3[5*n_worker//10: 6*n_worker//10, :] = np.random.multivariate_normal(beta36, 0.5 *np.eye(5), n_worker//10)
    B3[6*n_worker//10: 7*n_worker//10, :] = np.random.multivariate_normal(beta37, 0.5 *np.eye(5), n_worker//10)
    B3[7*n_worker//10: 8*n_worker//10, :] = np.random.multivariate_normal(beta38, 0.5 *np.eye(5), n_worker//10)
    B3[8*n_worker//10: 9*n_worker//10, :] = np.random.multivariate_normal(beta39, 0.5 *np.eye(5), n_worker//10)
    B3[9*n_worker//10:, :] = np.random.multivariate_normal(beta30, 0.5 *np.eye(5), n_worker//10)
    ...
    B4[5*n_worker//10: 6*n_worker//10, :] = np.random.multivariate_normal(beta46, 0.5 *np.eye(5), n_worker//10)
    B4[6*n_worker//10: 7*n_worker//10, :] = np.random.multivariate_normal(beta47, 0.5 *np.eye(5), n_worker//10)
    B4[7*n_worker//10: 8*n_worker//10, :] = np.random.multivariate_normal(beta48, 0.5 *np.eye(5), n_worker//10)
    B4[8*n_worker//10: 9*n_worker//10, :] = np.random.multivariate_normal(beta49, 0.5 *np.eye(5), n_worker//10)
    B4[9*n_worker//10:, :] = np.random.multivariate_normal(beta40, 0.5 *np.eye(5), n_worker//10)
    ...
    B5[5*n_worker//10: 6*n_worker//10, :] = np.random.multivariate_normal(beta56, 0.5 *np.eye(5), n_worker//10)
    B5[6*n_worker//10: 7*n_worker//10, :] = np.random.multivariate_normal(beta57, 0.5 *np.eye(5), n_worker//10)
    B5[7*n_worker//10: 8*n_worker//10, :] = np.random.multivariate_normal(beta58, 0.5 *np.eye(5), n_worker//10)
    B5[8*n_worker//10: 9*n_worker//10, :] = np.random.multivariate_normal(beta59, 0.5 *np.eye(5), n_worker//10)
    B5[9*n_worker//10:, :] = np.random.multivariate_normal(beta50, 0.5 *np.eye(5), n_worker//10)
    ...
    label_worker= np.array([0] * (n_task // 10) + [1] * (n_task // 10) + [2] * (n_task // 10)+ [3] * (n_task // 10)+ [4] * (n_task // 10)+ [5] * (n_task // 10)+ [6] * (n_task // 10)+ [7] * (n_task // 10)+ [8] * (n_task // 10)+ [9] * (n_task // 10))
    ######################getdata1 over
    
    ######LFGP

    model = LFGP(lf_dim=5, n_worker_group=10, lambda1=1, lambda2=1)
    ...
    for s in range(1):
        ...
        model._mc_fit(rating, label, epsilon=1e-4, maxiter=1, verbose=0)        
        pred_label = model._mc_infer(rating)
        tmp.append(np.mean(pred_label == label))
    acc[seed] = np.max(tmp)
